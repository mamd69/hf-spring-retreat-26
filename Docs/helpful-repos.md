...
A structured framework of markdown files that serves as a portable personal context package for AI agents — an "operating manual" so you don't have to repeatedly explain your identity, projects, goals, and preferences to different AI systems.
